...
export function Pricing() {
	const tiers = [
		{
			name: 'Стандарт',
			price: '9 999 тг',
			alt: '20 $ • 1 600 ₽ • 1 690 cом • 232 300 сум',
		...
		},
		{
			name: 'Экспресс',
			price: '20 000 тг',
			alt: '40 $ • 3 120 ₽ • 3 379 cом • 464 000 сум',
	...
	return (
		<section id='pricing' className='bg-surface-800 px-6 py-16 text-white'>
			<div className='mx-auto max-w-6xl'>
				<h2 className='text-3xl font-bold'>Стоимость</h2>
				<p className='mt-2 text-sm'>Прозрачные цены без скрытых платежей</p>
					...
					{tiers.map(tier => (
						...
						>
							...
							<CardContent className='space-y-2'>
								...
								<a
									href='https://wa.me/77000000000?text=Здравствуйте! Хочу обсудить заказ песни (SongX).'
									target='_blank'
